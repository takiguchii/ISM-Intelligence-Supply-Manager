...
{
    [Required(ErrorMessage = "Os dados do restaurante são obrigatórios.")]
    public RestaurantTenantRequest Restaurant { get; set; } = new();
...
public sealed class ManagerTenantRequest
{
